...
class UserMassSeeder extends Seeder
{
    ...
    private function createUsersWithProfiles(): void
    {
        ...
        Assert::object($userFactory);
        Assert::methodExists($userFactory, 'count');
        Assert::methodExists($userFactory, 'create');
        ...
        foreach ($users as $user) {
            ...
            Assert::object($profileFactory);
            Assert::methodExists($profileFactory, 'create');
        ...
        $this->command->info('✅ Creati '.((string) $usersCount).' utenti con profili completi');
    }
    ...
    private function createAuthenticationLogs(): void
    {
        ...
        /** @var \Illuminate\Database\Eloquent\Factories\Factory<\Modules\User\Models\AuthenticationLog> $factory */
        $factory = AuthenticationLog::factory();
    ...
    private function createUserDevices(): void
    {
        ...
        /** @var \Illuminate\Database\Eloquent\Factories\Factory<\Modules\User\Models\Device> $factory */
    ...
    private function createSocialProviders(): void
    {
        ...
        /** @var \Illuminate\Database\Eloquent\Factories\Factory<\Modules\User\Models\SocialProvider> $factory */
        $factory = SocialProvider::factory();
