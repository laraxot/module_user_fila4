...
class UserSeeder extends Seeder
{
    ...
    private function seedSystemTeams(): void
    {
        ...
        /** @var \Illuminate\Database\Eloquent\Factories\Factory<Team> $teamFactory */
        $teamFactory = Team::factory();
        Assert::object($teamFactory);
        Assert::methodExists($teamFactory, 'create');

        // Team di amministrazione
        $adminTeam = $teamFactory->create([
            'name' => 'Amministratori',
            'personal_team' => false,
        ]);

        // Team di sviluppo
        $devTeam = $teamFactory->create([
            'name' => 'Sviluppatori',
            'personal_team' => false,
        ]);

        // Team di supporto
        $supportTeam = $teamFactory->create([
            'name' => 'Supporto Clienti',
            'personal_team' => false,
        ]);

        // Team di marketing
        $marketingTeam = $teamFactory->create([
            'name' => 'Marketing',
            'personal_team' => false,
        ]);

        // Team generale
        $generalTeam = $teamFactory->create([
            'name' => 'Team Generale',
            'personal_team' => false,
        ]);
