...
return [
    ...
    'gdpr' => [
        ...
        'consent_section' => 'Privacy and terms consent',
        'privacy_checkbox_html' => 'I have read and accept the <a href=":privacy_url" target="_blank" class="underline font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400">Privacy Policy</a> and consent to the processing of my personal data.',
        'terms_checkbox_html' => 'I have read and accept the <a href=":terms_url" target="_blank" class="underline font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400">Terms and Conditions</a>.',
