...
Gli avatar SVG sono posizionati nella directory `/laravel/Modules/UI/resources/svg/avatars/` seguendo le convenzioni di <main module> per i componenti SVG. Sono stati creati quattro avatar predefiniti con design simpatici e colorati:
...
Questi avatar vengono registrati automaticamente come componenti Blade con il prefisso `ui-avatars` grazie al sistema di registrazione delle icone di <main module>.
...
- [Architettura Modulare <main module>](/docs/architettura-modulare.md)
