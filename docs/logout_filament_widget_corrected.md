...
Questo documento descrive l'implementazione corretta del logout utilizzando un widget Filament, rispettando le convenzioni di <main module> e la struttura di `XotBaseWidget`. L'approccio con widget Filament è particolarmente utile quando si desidera mantenere una pagina di conferma per il logout.
...
2. **Convenzioni di <main module> per i Widget**:
...
5. **Conformità alle convenzioni**: Segue le convenzioni di <main module> per i widget Filament.
