...
```
Class Modules\Meetup\Models\Cliente not found.
Class Modules\Meetup\Models\Apparecchio not found.
```
...
- `Modules/Meetup/app/Console/Commands/ImportAccessDataCommand.php`
- `Modules/Meetup/app/Contracts/PivotContract.php`
- `Modules/Meetup/app/Contracts/WorkerContract.php`
...
```
Method Modules\Meetup\Models\Worker::setBirthDayAttribute() has parameter $value with no type specified.
```
...
```
Call to static method make() on an unknown class Modules\Meetup\Filament\Resources\ClientResource\Pages\Filament\Infolists\Components\Section.
```
...
```php
// Before
use Modules\Meetup\Filament\Resources\ClientResource\Pages\Filament\Infolists\Components\Section;
